...
vector<vector<Point>> sample_interval(
    Drawable const & d, Transform const & t, Cover const & clip, 
    size_t sample_count = 10000, pair<double,double> interval = {0., 1.})
{
