...
void ConstantArcLengthAdapter::init()
{
...
ConstantArcLengthAdapter::ConstantArcLengthAdapter(
        Drawable const & d, 
...
double ConstantArcLengthAdapter::length(double t0, double t1) const
{
    if(t0 < t1)
    {
...
Event ConstantArcLengthAdapter::at(double t) const
{
